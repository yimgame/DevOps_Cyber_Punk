...
import heroBackground from "@assets/generated_images/cyberpunk_neon_grid_hero_background.png";

export default function HeroSection() {
  const [displayText, setDisplayText] = useState("");
  const fullText = "Security Researcher & DevOps Engineer";
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0" style={{
          backgroundImage: `
            linear-gradient(to right, rgb(0 240 255 / 0.1) 1px, transparent 1px),
            linear-gradient(to bottom, rgb(0 240 255 / 0.1) 1px, transparent 1px)
          `,
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl text-foreground/70 mb-12 max-w-2xl mx-auto font-light" data-testid="text-hero-description">
          Penetration testing, red team operations, and infrastructure automation. 
